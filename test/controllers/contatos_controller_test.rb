...
class ContatosControllerTest < ActionController::TestCase
  ...
  test "should create contato" do
    assert_difference('Contato.count') do
      post :create, contato: { mensagem: @contato.mensagem, tipo_id: @contato.tipo_id, user_id: @contato.user_id }
    end
  ...
  test "should update contato" do
    patch :update, id: @contato, contato: { mensagem: @contato.mensagem, tipo_id: @contato.tipo_id, user_id: @contato.user_id }
    assert_redirected_to contato_path(assigns(:contato))
  end
